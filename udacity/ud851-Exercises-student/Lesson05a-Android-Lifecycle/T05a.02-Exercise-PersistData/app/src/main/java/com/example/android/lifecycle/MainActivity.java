...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifecycle callbacks!!!!!\n\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            String savedPreviousState = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(savedPreviousState);
        }
