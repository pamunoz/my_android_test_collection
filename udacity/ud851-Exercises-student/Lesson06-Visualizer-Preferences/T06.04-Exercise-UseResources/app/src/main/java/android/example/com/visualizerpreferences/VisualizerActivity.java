...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.visualizer_pref_checkbox_key), getResources().getBoolean(R.bool.visualizer_checkbox_default)));
