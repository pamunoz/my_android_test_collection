...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String messageToShare = "This is something I've like to share";

        // DONE (6) Replace the Toast with shareText, passing in the String from step 5
        //Toast.makeText(this, "ODO: Share text when this is clicked", Toast.LENGTH_LONG).show();
    ...
    private void shareText(String text) {
        ...
        String titleChooser = "Text Chooser";
        try {
            ShareCompat.IntentBuilder.from(this)
                    .setType(mimeType)
                    .setChooserTitle(titleChooser)
                    .setText(text)
                    .startChooser();
        } catch (Exception e) {
            e.printStackTrace();
