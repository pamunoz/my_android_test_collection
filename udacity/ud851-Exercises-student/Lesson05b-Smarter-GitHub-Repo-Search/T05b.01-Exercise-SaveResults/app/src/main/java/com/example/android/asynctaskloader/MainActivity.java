...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEACH_QUERY_URL_EXTRA = "query";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String urlDisplayTextView = savedInstanceState.getString(SEACH_QUERY_URL_EXTRA);
            String rawJasonDisplayTextView = savedInstanceState.getString(SEARCH_RESULT_RAW_JSON);

            mUrlDisplayTextView.setText(urlDisplayTextView);
            mSearchBoxEditText.setText(rawJasonDisplayTextView);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String urlText = mUrlDisplayTextView.getText().toString().trim();
        outState.putString(SEACH_QUERY_URL_EXTRA, urlText);
        ...
        String rawJsonText = mSearchResultsTextView.getText().toString().trim();
        outState.putString(SEARCH_RESULT_RAW_JSON, rawJsonText);
    }
}