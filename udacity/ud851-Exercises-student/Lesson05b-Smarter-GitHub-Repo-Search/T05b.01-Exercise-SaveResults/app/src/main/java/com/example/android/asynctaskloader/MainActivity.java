...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String QUERY_URL = "www.google.cl";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String rawJson = savedInstanceState.getString(JSON_KEY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String pageUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL, pageUrl);
        ...
        outState.putString(JSON_KEY, rawJson);
    }
}