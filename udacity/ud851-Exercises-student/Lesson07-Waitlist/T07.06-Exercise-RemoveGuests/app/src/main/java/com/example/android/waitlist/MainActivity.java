...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean removeGuest(long id) {
        ...
        String idElementToDelete = WaitlistContract.WaitlistEntry._ID + "=" + String.valueOf(id);
        String tableName = WaitlistContract.WaitlistEntry.TABLE_NAME;
        long idElementDeleted = mDb.delete(tableName, idElementToDelete, null);
        return idElementDeleted > 0;
    }
