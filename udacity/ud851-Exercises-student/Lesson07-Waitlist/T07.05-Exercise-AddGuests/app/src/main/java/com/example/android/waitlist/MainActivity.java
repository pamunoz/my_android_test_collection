...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if (!hasContent(mNewGuestNameEditText) || !hasContent(mNewPartySizeEditText)) return;
    ...
    /**
     * Utility method for checking if there is input on a {@link EditText}.
     * @param editText the editText to be evaluated.
     * @return true if there is input or false otherwise.
     */
    ...
    private void addGuest(String guestName, int partySize) {
        ...
        long newRowId = mDb.insert(WaitlistContract.WaitlistEntry.TABLE_NAME, null, values);
    }
