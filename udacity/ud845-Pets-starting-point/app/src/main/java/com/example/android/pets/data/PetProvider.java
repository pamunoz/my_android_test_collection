...
public class PetProvider extends ContentProvider {
    ...
    static {
        ...
        // For example, "content://com.example.android.pets/pets/3" matches, ut
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PETS:
                // For the PETS code query directly the pets tale directly with the given
                // projection, selection, selection arguments, and sort order. The cursor could
                // contain multiples rows of the pets table.
                cursor = database.query(PetEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case PET_ID:
                // For the PET_ID code, extract out the ID from the URI.
                // for an example URI, such ass: "content://com.example.android.pets/pets/3",
                ...
                // this will perform a query in the pets table where the id equals 3 to return a
